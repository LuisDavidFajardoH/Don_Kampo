...
const CreateProduct = () => {
  ...
  const handleSubmit = async (values) => {
    ...
    formData.append(
      "stock",
      values.stock !== undefined ? parseInt(values.stock, 10) : 0
    );
    formData.append("photo", imageFile);
    formData.append(
      "price_home",
      values.price_home !== undefined && values.price_home !== ""
        ? parseFloat(values.price_home)
        : 0
    );
    formData.append(
      "price_supermarket",
      values.price_supermarket !== undefined
        ? parseFloat(values.price_supermarket)
        : 0
    );
    formData.append(
      "price_restaurant",
      values.price_restaurant !== undefined
        ? parseFloat(values.price_restaurant)
        : 0
    );
    formData.append(
      "price_fruver",
      values.price_fruver !== undefined ? parseFloat(values.price_fruver) : 0
    );
  ...
  const handleConfirmUpload = async () => {
    products.forEach(async (product) => {
      ...
      formData.append(
        "stock",
        product.stock !== undefined ? parseInt(product.stock, 10) : 0
      );
      formData.append(
        "price_home",
        product.price_home !== undefined ? parseFloat(product.price_home) : 0
      );
      formData.append(
        "price_supermarket",
        product.price_supermarket !== undefined
          ? parseFloat(product.price_supermarket)
          : 0
      );
      formData.append(
        "price_restaurant",
        product.price_restaurant !== undefined
          ? parseFloat(product.price_restaurant)
          : 0
      );
      formData.append(
        "price_fruver",
        product.price_fruver !== undefined
          ? parseFloat(product.price_fruver)
          : 0
      );
    ...
    const sampleData = [
      {
        ...
        stock: 100,
        price_home: 1.2,
        price_supermarket: 1.1,
        price_restaurant: 1.5,
        price_fruver: 1.3,
      },
      {
        name: "Lechuga",
        description: "Verdura verde y fresca",
        category: "Verdura",
        stock: 200,
        price_home: 0.8,
        price_supermarket: 0.75,
        price_restaurant: 1.0,
        price_fruver: 0.9,
      },
    ];
  ...
  const columns = [
    ...
    {
      title: "Precio Supermercado",
      dataIndex: "price_supermarket",
      key: "price_supermarket",
    },
    {
      title: "Precio Restaurante",
      dataIndex: "price_restaurant",
      key: "price_restaurant",
    },
